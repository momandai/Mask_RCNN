...
# Generate Anchors
backbone_shapes = modellib.compute_backbone_shapes(config, config.IMAGE_SHAPE)     # [[256, 256], [128, 128], [64, 64], [32, 32], [16, 16]]
...
anchors_per_cell = len(config.RPN_ANCHOR_RATIOS)  # 3
